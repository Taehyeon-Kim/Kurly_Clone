//
//  ProductFrugalViewController.swift
//  Kurly_mock
//
...
class ProductFrugalViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        dataManager.getFrugalProducts(filterType: "B", mainCategoryID: "1", delegate: self)
...
extension ProductFrugalViewController {
    
    // 데이터 담기
    func getFrugalProducts(result: [ProductsResult]) {
...
extension ProductFrugalViewController: UICollectionViewDelegate {
...
extension ProductFrugalViewController: UICollectionViewDataSource {
