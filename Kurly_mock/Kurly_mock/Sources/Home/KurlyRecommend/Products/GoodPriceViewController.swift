...
class GoodPriceViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        dataManager.getGoodPrice(filterType: "B", mainCategoryID: "3", delegate: self)
...
extension GoodPriceViewController {
    
    // 데이터 담기
    func getGoodPrice(result: [ProductsResult]) {
...
extension GoodPriceViewController: UICollectionViewDelegate {
...
extension GoodPriceViewController: UICollectionViewDataSource {
