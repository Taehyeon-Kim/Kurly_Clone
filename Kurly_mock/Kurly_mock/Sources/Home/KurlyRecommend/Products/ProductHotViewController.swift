//
//  ProductHotViewController.swift
//  Kurly_mock
//
...
class ProductHotViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        dataManager.getHotProducts(filterType: "B", mainCategoryID: "1", delegate: self)
...
extension ProductHotViewController {
    
    // 데이터 담기
    func getHotProducts(result: [ProductsResult]) {
...
extension ProductHotViewController: UICollectionViewDelegate {
...
extension ProductHotViewController: UICollectionViewDataSource {
